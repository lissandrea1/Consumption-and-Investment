%% Relative Risk Aversion Parameter Doubled

beta = 0.96;
gamma = 2.6;        %Setting the parameter double
r = 0.04;
sigma = 0.04;
...
a_prime_index = zeros(a_n, Y_n); % Preallocation of the asset choice policy function index %BUG 5: asset preallocation
